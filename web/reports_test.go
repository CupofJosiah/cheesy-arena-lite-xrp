...
func TestRankingsCsvReport(t *testing.T) {
	...
	expectedBody := "Rank,TeamId,RankingPoints,MatchPoints,AutoPoints,TeleopPoints,EndgamePoints,Wins,Losses,Ties," +
		"Disqualifications,Played\n1,254,20,625,90,381,154,3,2,1,0,10\n2,1114,18,700,125,485,90,1,3,2,0,10\n\n"
