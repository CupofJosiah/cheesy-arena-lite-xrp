...
func (web *Web) newHandler() http.Handler {
	...
	mux.HandleFunc("GET /api/scores", web.scoresApiHandler)
	mux.HandleFunc("PUT /api/scores", web.scoresApiHandler)
	mux.HandleFunc("PATCH /api/scores", web.scoresApiHandler)
	...
	mux.HandleFunc("GET /panels/scoring", web.scoringPanelHandler)
	mux.HandleFunc("GET /panels/scoring/websocket", web.scoringPanelWebsocketHandler)
	...
	mux.HandleFunc("POST /setup/schedule/swap", web.scheduleSwapPostHandler)
